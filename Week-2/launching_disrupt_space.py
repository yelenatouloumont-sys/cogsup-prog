...
# Spatial gap manipulation
gap = 40  # we can change this value to see if the collision effect is still present
# NB:
## Squares are 50px wide.
## Normally contact happens at red_x = -50
## Now we stop earlier to create a gap.
contact_position = -50 - gap

# PHASE 1: Move RED square (square_1) toward GREEN square (square_2)
while square_1.position[0] < contact_position: #it stops before touching the green square because of the gap
