...
# Temporal delay after collision
delay = 2000   # we can modulate this value to see if the collision effect is still present
square_1.present(clear=True, update=False)
square_2.present(clear=False, update=True)

# Wait before green (square_2) starts moving
